...
def from_config_dict(config, hass=None, config_dir=None, enable_log=True,
    ...
    try:
        ...
        cv.log_exception(_LOGGER, ex, 'blumate', core_config)
        return None
    ...
    # Filter out the repeating and common config section [blumate]
...
def process_ha_core_config(hass, config):
    """Process the [blumate] section from the config."""
    hac = hass.config
