...
from blumate.components import discovery, group
...
from blumate.helpers.service import extract_entity_ids
...
class EntityComponent(object):
    ...
    def setup(self, config):
        ...
        # Refer to: blumate.components.discovery.load_platform()
